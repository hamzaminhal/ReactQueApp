...
export default function LoginPage() {
  const { loginWithFacebook, loginWithEmail, signUpWithEmail, loginWithGoogle } = useAuth();
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 via-white to-violet-50 dark:from-gray-950 dark:via-gray-900 dark:to-indigo-950 transition-colors relative overflow-hidden">
      ...
      type="button"
      className="w-full flex items-center justify-center gap-3 px-6 py-3 my-2 rounded-2xl text-sm font-medium text-gray-700 bg-white border border-gray-300 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200"
    >
      <svg 
        className="w-5 h-5" 
        viewBox="0 0 24 24" 
